...
if __name__ == "__main__":
    ...
    parser.add_argument("--datasetdir", type=str, default="./dataset/cacti/photomechanical_imaging_simu", \
                        help="Path to the Data to be Reconstructed")
    parser.add_argument("--resultsdir", type=str, default="./results_simu_pi", \
    ...
    # --------------------------------------- GAP-TV --------------------------------------- #
    main(argspar, method="gap-tv", iter_max=40)
    ...
    # ----------------------------------- PnP-FastDVDnet ----------------------------------- #
    main(argspar, method="pnp-fastdvdnet", sigma=[100/255, 50/255], iter_max=[20, 20])
    
    # ------------------------- PnP-BiFastDVDnet (PnP+BiFastDVDnet) ------------------------- #
    main(argspar, method="pnp-bifastdvdnet", sigma=[75/255, 75/255], iter_max=[20, 20])
    
    # --------------------------- RCO-BDPnP (PnP+BiFastDVDnet+MMCO) ------------------------- #
    main(argspar, method="rco-bdpnp", sigma=[75/255, 75/255], iter_max=[20, 20], MMCO=True)